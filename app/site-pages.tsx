...
const referenceImgs = [
  ...
  ...['dc99e3_8c732ebcb2db4eea86e2b66bab598549~mv2.jpg','dc99e3_e5bbaf7f1a2d4963ac2ca79deec78fa0~mv2.avif','dc99e3_0aa1a099b06c4a18ae13fee906be09f6~mv2.jpg','dc99e3_fcb8be4f8c6144ffb1e6d903274b158e~mv2.jpg','dc99e3_7a4616ef6e3a4d5a8c43c8fe9ca41b07~mv2.jpg','dc99e3_ee8810d62fa44c3487fb43619c4490e6~mv2.jpg','dc99e3_9120c5192ebf4939b1631240c7c7a826~mv2.jpg','dc99e3_61b185756e99468697af210973615eaa~mv2.jpg','dc99e3_3d53cf35b2ac4782afc776c6de9a0cd5~mv2.jpg','dc99e3_75016352961646b3bff68ed0029d8242~mv2.jpg','dc99e3_355fe6cc940e48b1bde56deb074b9ea3~mv2.jpg','dc99e3_5c14f99dfa6047a8b06e36c66244226e~mv2.jpg','dc99e3_b45d43522b3745dfb0a3389e0cfb843b~mv2.jpg','dc99e3_46121686f8ae49f1a37f58604b30ef06~mv2.jpg','dc99e3_c5b05edfe4194c10812d28b4a916c85c~mv2.jpg','dc99e3_c44257048cfc4ba392121f05d8d90cbc~mv2.png','dc99e3_271eb6cfe4364100aeab633cc05cb1c1~mv2.webp','dc99e3_cb1bf1bf9ffe48ccb4fadee5f5893569~mv2.jpg','dc99e3_6a35deb12db44ae6a5dc818273613939~mv2.jpg','dc99e3_8d0c6b04ebef44ed86dffa99adac6092~mv2.jpg','dc99e3_8bd84feb91ea47b29818f7bb3505a299~mv2.jpg','dc99e3_f12d49465eb44bfeb0cc55b0371e22c3~mv2.jpg','dc99e3_0385e954e9e94222bd53583b05e926ce~mv2.jpg','dc99e3_6e2c7053b833493b8d4f5648fcbff005~mv2.jpg','dc99e3_2894988070fa41f7abe956b56b0cb373~mv2.jpg','dc99e3_34274e260346411d8b5731cb6a6c2fa5~mv2.jpg','dc99e3_db39690806c44c5d97870e1ac163c7bd~mv2.png'].map(id=>`https://static.wixstatic.com/media/${id}/v1/fill/w_280,h_162,al_c,q_80,enc_avif,quality_auto/reference.jpg`),
];
...
export function AcademyPage() {
  ...
  return <Shell className="academy-page"><section className="academy-hero"><div><h1>RIZZ ACADEMY</h1><p className="academy-lead">콘텐츠로 시작하여 비즈니스까지.<br />실전으로 증명된 크리에이터들의 성장 전략을 배웁니다.</p><div className="academy-copy"><strong>글로우업리즈 아카데미는</strong><span>8년간 유튜브로 수많은 실험과 성장을 경험한 크리에이터가 전하는<br />유튜브 기획, 수익화, 브랜드 확장, 그리고 콘텐츠 기반 사업화까지<br />실무 중심으로 설계된 실전형 교육 플랫폼입니다.</span></div></div></section><section className="academy-teacher"><h2><span>✦</span>유튜브 하나로 사업까지 확장해낸 실전형 CEO가 직접 강의합니다.</h2><div className="lecturer"><img src="https://static.wixstatic.com/media/a3e44e_bad62282522b4da283dcff636b0aff34~mv2.jpg/v1/fill/w_400,h_460,fp_0.50_0.44,q_80,usm_0.66_1.00_0.01,enc_avif,quality_auto/1030_%ED%94%84%EB%A1%9C%ED%95%8418116.jpg" alt="권기동" /><div><p>채널주인부재중 운영자 / 글로우업리즈 대표</p><h3>권기동</h3><ul>{points.map(point => <li key={point}>- {point}</li>)}</ul></div></div></section><section className="coming"><div className="coming-cards">{Array.from({ length: 5 }).map((_, i) => <article key={i} />)}</div><div className="coming-copy"><h2>COMING SOON</h2><p>실무 경험 중심의 콘텐츠 전문가들이<br />순차적으로 합류할 예정입니다.</p></div></section></Shell>;
}
...
function FnbHero() { return <section className="fnb-hero"><h1>THE RIZZ ROOM</h1><div><h2>&quot;Our flavor. Our rules.&quot;</h2><p>글로우업리즈의 F&amp;B 매장은 우리의 쇼룸입니다.<br />이곳은 단순한 공간이 아닌, 우리만의 감각과 철학이 응축된 브랜드 무대입니다.<br />우리는 정해진 매뉴얼보다 감각과 경험으로 채워지는 순간을 더 믿습니다.<br />그 무한한 가능성을 위해 오늘도 실험하고, 고민하고, 나아갑니다.</p></div></section>; }
...
export function FnbPage() {
  ...
  const spaceImages = ['dc99e3_21a12ea944bf4bb9824458abbd010dab~mv2.jpg','dc99e3_a0f041ffc3294702a825828e166a6ab7~mv2.jpg','dc99e3_b3bcae5862dc4977856503ff00bb8202~mv2.jpg','dc99e3_60f45e34815b479b8f7eb6e5ec430373~mv2.jpg','dc99e3_77717eaa76ce4a87a2102974812ee96f~mv2.jpg'];
  return <Shell className="fnb-page"><FnbHero /><SideRail items={fnbRail} active="도그아웃" /><section className="fnb-brand"><img className="fnb-mark" src="https://static.wixstatic.com/media/dc99e3_04119e9f5bde4a51acac39b7a1876f70~mv2.jpg/v1/fill/w_200,h_200,al_c,q_80,usm_0.66_1.00_0.01,enc_avif,quality_auto/logo.jpg" alt="서교닭매운탕" /><div><h2>닭요리의 틀을 깨다, 맛의 기준을 바꾸다.</h2><p>전통의 깊이를 존중하되, 고정관념에 안주하지 않습니다.<br />닭볶음탕과 매운탕의 경계를 넘나드는 새로운 해석,<br />익숙하지만 신선한 조합으로 닭요리의 정체성을 다시 씁니다.<br />우리는 단순히 음식을 만드는 것이 아니라 새로운 기준과 브랜드 경험을 제시합니다.</p></div></section><section className="fnb-menu"><h2>끊임없는 메뉴 개발과 맛으로 증명하는 경쟁력,<br />서교닭매운탕의 성장 엔진입니다.</h2><div className="fnb-food-grid">{foodImages.map((src, i) => <article key={src}><img src={src} alt={foods[i]} /><span>{foods[i]}</span></article>)}</div><h3>서교닭매운탕 본점</h3><a href="https://www.instagram.com/" aria-label="Instagram">◎</a><div className="fnb-space-gallery"><img src={`https://static.wixstatic.com/media/${spaceImages[0]}/v1/fill/w_809,h_324,al_c,q_80,usm_0.66_1.00_0.01,enc_avif,quality_auto/space.jpg`} alt="서교닭매운탕 매장" />{spaceImages.slice(1).map(id=><img src={`https://static.wixstatic.com/media/${id}/v1/fill/w_400,h_243,al_c,q_80,usm_0.66_1.00_0.01,enc_avif,quality_auto/space.jpg`} alt="서교닭매운탕 공간" key={id} />)}</div></section><StoreInfo items={[['주소','서울 마포구 독막로 3길 51, 서주빌딩'],['영업시간','11:00 - 23:00'],['브레이크타임','15:00 - 17:00'],['라스트오더','22:00'],['전화번호','070-7799-6848']]} /></Shell>;
}
...
export function SushiPage() { return <Shell className="fnb-page"><FnbHero /><SideRail items={fnbRail} active="스시준" /><section className="restaurant-page sushi-page"><img className="restaurant-logo sushi-logo" src="https://static.wixstatic.com/media/dc99e3_8cd41ebb0cc141fe8403f613aeccb6e2~mv2.png/v1/fill/w_438,h_482,al_c,q_85,enc_avif,quality_auto/sushijun.png" alt="스시준" /><h1>한 접시의 정성으로 브랜드의 깊이를 전하는 곳</h1><p>공덕역 뒷골목에서 시작하여 14년 경력의 셰프가 이끌어온 스시준,<br />글로우업리즈 사옥에서 새롭게 출발합니다.</p><h3>Chef. 이준엽</h3><p>매일 새벽 직접 선별한 재료와 정교한 손길로 완성된 오마카세는 단순한 식사를 넘어 깊은 신뢰를 쌓아왔습니다. 단골들의 오랜 재방문과 찬사는 스시준이 하나의 브랜드로 자리 잡은 이유입니다.<br /><br />지금, 스시준은 우리 글로우업리즈를 대표하는 하이퀄리티 F&amp;B 오마카세 브랜드입니다.</p><ImageGrid ids={sushiImgs} square={false} /><h2>스시준 성수</h2><div className="restaurant-details"><img src="https://static.wixstatic.com/media/dc99e3_44f71267fdb644fbb233243e5e0af176~mv2.png/v1/fill/w_809,h_480,al_c,q_85,enc_avif,quality_auto/menu.png" alt="스시준 메뉴" /><img src="https://static.wixstatic.com/media/dc99e3_0df149c040d64489914357454445eb6d~mv2.png/v1/fill/w_809,h_283,al_c,q_85,enc_avif,quality_auto/info.png" alt="스시준 안내" /></div><StoreInfo items={[['주소','서울 성동구 연무장19길 6, RIZZ'],['예약타임','런치 - 12:00, 13:30  |  디너 - 18:00, 20:00'],['엽업시간','10:00 - 21:00 (매주 월요일 정기 휴무)'],['브레이크 타임','15:00 ~ 17:00'],['전화번호','02-2205-4889']]} inner /><a className="reserve" href="tel:0222054889">예약하기</a></section></Shell>; }
export function UdonPage() { return <Shell className="fnb-page"><FnbHero /><SideRail items={fnbRail} active="에끼우동" /><section className="restaurant-page udon-page"><img className="restaurant-logo udon-logo" src="https://static.wixstatic.com/media/dc99e3_e22f6a046abe404ebf1af122aacda996~mv2.png/v1/fill/w_716,h_202,al_c,q_85,enc_avif,quality_auto/ekiudon.png" alt="에끼우동" /><h1>간판만 있는 식당이 아닌, 브랜드가 살아있는 공간</h1><p>단순하지만 깊은 맛, 우동 본질에 대한 진심이 담긴 한 그릇이 짧은 시간 수많은 재방문과 따뜻한 고객 리뷰로 진정성을 증명했습니다.<br /><br />그 깊이를 고스란히 담아낼 공간까지 직접 설계했고, 직접 기획한 브랜드를 우리의 사옥에 품어 고객이 오롯이 보고, 느끼고, 경험할 수 있도록 준비했습니다.</p><ImageGrid ids={udonImgs} square /><h2>성수 에끼우동</h2><div className="restaurant-details"><img src="https://static.wixstatic.com/media/dc99e3_bec311eefc9249cc999f8ebb74d7328f~mv2.png/v1/fill/w_809,h_324,al_c,q_85,enc_avif,quality_auto/menu.png" alt="에끼우동 메뉴" /><img src="https://static.wixstatic.com/media/dc99e3_f9265339e51e47fdb4952dee92961336~mv2.png/v1/fill/w_809,h_324,al_c,q_85,enc_avif,quality_auto/info.png" alt="에끼우동 안내" /></div><StoreInfo items={[['주소','서울 성동구 연무장19길 6, RIZZ'],['영업시간','10:00 - 21:00'],['브레이크타임','15:00 - 17:00'],['라스트오더','20:30']]} inner /></section></Shell>; }
